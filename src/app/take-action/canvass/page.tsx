    ...
    <section className="py-16 px-6">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-8">
          When we undertake a canvassing action with other organizations and campaigns, our partners provide all the training, tips, and tools you will need to get started.
        </p>
