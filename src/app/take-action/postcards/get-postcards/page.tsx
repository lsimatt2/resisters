...
export const metadata: Metadata = {
  title: "Get Postcards | ReSisters CT",
  description:
    "Find out where to get postcards for your campaign.",
};
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100 shadow-sm">
      <div className="mx-auto max-w-6xl flex items-center justify-between px-6 py-3">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-700">
          ...
          <Link
            href="/#signup"
            className="bg-berry-700 text-white px-5 py-2 rounded-full hover:bg-berry-800 transition-colors"
          >
            Join Us
          </Link>
        </div>
...
function Hero() {
  return (
    <section className="pt-24 pb-12 px-6 bg-gradient-to-b from-green-50 to-white text-center">
      <div className="mx-auto max-w-3xl">
        <Link
          href="/take-action/postcards"
          className="text-green-logo hover:text-berry-700 transition-colors text-sm"
        >
          &larr; Back to Postcards
        </Link>
        <h1 className="text-4xl md:text-5xl font-bold mt-4 mb-4 text-berry-900">
          Get Postcards
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm leading-relaxed">
              ReSisters is a grassroots activist organization founded in
              Westport, CT in 2016. Now active throughout Connecticut and
              beyond, we are dedicated to promoting candidates and causes in
              support of American democracy.
            </p>
          </div>
          <div>
...
export default function GetPostcardsPage() {
  return (
    <>
      <Navbar />
      <main>
