    ...
    <section className="py-16 px-6">
      <div className="mx-auto max-w-4xl">
        <div className="flex items-center gap-4 mb-4">
          <div className="w-14 h-14 bg-green-50 text-green-700 rounded-xl flex items-center justify-center">
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 2c0 1.5-1.5 2-1.5 3.5S8 7.5 8 7.5M12 2c0 1.5-1.5 2-1.5 3.5S12 7.5 12 7.5M16 2c0 1.5-1.5 2-1.5 3.5S16 7.5 16 7.5" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 9h14v5a6 6 0 01-6 6H9a6 6 0 01-6-6V9z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 10h1.5a2.5 2.5 0 010 5H17" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2 22h20" />
            </svg>
          </div>
