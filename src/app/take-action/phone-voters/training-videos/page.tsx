...
export const metadata: Metadata = {
  title: "Phone Bank Training Videos | ReSisters CT",
  description:
    "Watch training videos for phone banking software used by ReSisters CT campaigns.",
};
