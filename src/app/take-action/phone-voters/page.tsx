...
export const metadata: Metadata = {
  title: "Phone Voters | ReSisters CT",
  description:
    ...
    <section className="relative bg-green-50 text-gray-900 pt-28 pb-16 px-6">
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Outside of face-to-face contact, phoning voters is the most effective
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-5 text-lg text-gray-700 leading-relaxed">
          ...
          <p>
            ...
            Imagine helping someone register to vote so they can exercise
...
function TheImpact() {
  const points = [
    ...
    },
    {
      ...
      description:
        "A secondary benefit is that phone banking informs our partners about non-working phone numbers and relocated voters so that future phone bankers and campaigns can be more efficient with their calls.",
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description:
        "ReSisters often phone bank during our Resistance Cafe. It's great to have company — share tips, celebrate successes, and learn from others.",
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="py-16 px-6 bg-gradient-to-r from-green-50 to-white text-gray-900">
      <div className="mx-auto max-w-3xl text-center">
        <h2 className="text-3xl font-bold mb-4 text-berry-800">Ready to Phone Voters?</h2>
...
export default function PhoneVotersPage() {
  return (
    <>
      <Navbar />
      <main>
