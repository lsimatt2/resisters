...
const actions = [
  {
    title: "Amplify",
    description: "Get the message out on social media platforms.",
    icon: (
  ...
  {
    title: "Phone",
    description: "Make persuasive calls to voters and legislators.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10 text-left">
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
            ...
            <p className="text-green-800 mt-2">
              Monday evenings, 7pm recap on Zoom for those who can&apos;t attend in the morning.
            </p>
          </div>
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
